...
- **Unified invocation across transports** — the same Conductor handlers run uniformly from HTTP requests, SignalR Hub methods, and raw WebSocket frames; per-message `IUserState` is consistent across all three
